...
# --- AYARLAR (Render Panelinden veya Manuel Girilecek) ---
# os.getenv kullanıyoruz ki Render üzerinden anahtarlarını güvenle yönetebil
TELEGRAM_TOKEN = os.getenv('TELEGRAM_TOKEN', 'TOKEN_YAZ')
TELEGRAM_CHAT_ID = os.getenv('TELEGRAM_CHAT_ID', 'ID_YAZ')
API_KEY = os.getenv('BTCTURK_API_KEY', 'KEY_YAZ')
API_SECRET = os.getenv('BTCTURK_API_SECRET', 'SECRET_YAZ')
...
def en_hareketli_20_coin():
    ...
    except: return ['BTC/USDT', 'ETH/USDT', 'SOL/USDT', 'AVAX/USDT']

def run_bot():
    global bellek, son_rapor_vakti
    tg_mesaj("🎯 Robot GERÇEK ALIM-SATIM Modunda Başladı!\n7/24 Takip aktif.")
            ...
            if not bellek["aktif"]:
                ...
                for s in watchlist:
                    ...
                    if rsi < 30:
                        ...
                        usdt_bal = exchange.fetch_balance()['total']['USDT'] * BAKIYE_ORANI
